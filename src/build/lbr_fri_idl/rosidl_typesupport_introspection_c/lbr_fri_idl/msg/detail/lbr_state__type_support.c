...
static rosidl_typesupport_introspection_c__MessageMember lbr_fri_idl__msg__LBRState__rosidl_typesupport_introspection_c__LBRState_message_member_array[17] = {
  {
    "sample_time",  // name
